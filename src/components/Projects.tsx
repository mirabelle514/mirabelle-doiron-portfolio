...
const Projects = () => {
  ...
  return (
    <div id="projects" className="py-20 px-6" style={{ backgroundColor: tokens.colors.bg.secondary }}>
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl font-bold mb-12 text-center" style={{ color: tokens.colors.text.primary }}>Projects</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((project, index) => (
            ...
            >
              <p className="text-xs font-medium uppercase tracking-wide mb-3" style={{ color: tokens.colors.text.muted }}>
                {project.type}
              </p>
              
              <h3 className="text-lg font-semibold mb-3" style={{ color: tokens.colors.text.primary }}>{project.title}</h3>
              <p className="mb-4 text-sm" style={{ color: tokens.colors.text.secondary }}>{project.description}</p>
              ...
              <a 
                ...
                style={{ color: tokens.colors.accent.burgundy }}
              >
                View details
              </a>
            </div>
